...
const heroSlides = [
  {
    ...
    description:
      "Passion, talent and can-do attitude. That's the Market Eyes way!! CMMI level 5 and ISO 27001 certified Company delivering best IT Services across Technology spectrum.",
